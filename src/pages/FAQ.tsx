...
export const FAQ: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "نعم، جميع إجراءاتنا وعقودنا واستشاراتنا مصممة لتتوافق تماماً مع أنظمة وزارة العدل، ونظام التنفيذ، ونظام إيجار، وكافة التشريعات العقارية المعمول بها في المملكة العربية السعودية."
    },
    {
